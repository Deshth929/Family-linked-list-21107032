...
int main() {
LinkedList* myLinkedList = new LinkedList("Grandma", 76);
myLinkedList.append("Dad", 46);
myLinkedList.append("Mom", 42);
myLinkedList.append("Deshth", 20);
myLinkedList.append("Sister", 13);
}
